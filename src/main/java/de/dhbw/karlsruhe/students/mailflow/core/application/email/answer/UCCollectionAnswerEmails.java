 ...
 * @author Jonas-Karl
 */
public record UCCollectionAnswerEmails(AnswerSenderService answerSenderEmailService) {
  public static UCCollectionAnswerEmails init(EmailSendUseCase emailSendUseCase) {
    // Also AnswerAllEmailsService in the future
    return new UCCollectionAnswerEmails(new AnswerSenderService(emailSendUseCase));
  }
}
