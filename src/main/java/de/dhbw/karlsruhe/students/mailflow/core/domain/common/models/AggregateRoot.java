...
/**
 * An abstract class template for every AggregateRoot object that will be created. Aggregate Roots
 * are special types of entities that serve as the entry points to aggregates and encapsulate the
