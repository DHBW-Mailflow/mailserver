...
class JSONParserTest {
  ...
  void successfullyParseJsonToMailbox() {
    ...
    EmailMetadata emailMetadata = new EmailMetadata(new Subject("some Subject"), owner,
    ...
    // Assert
    assertThat(mailbox).isNotNull().isLenientEqualsToByIgnoringFields(expectedMailbox, "id",
        "emails");
